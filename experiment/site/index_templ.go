...
func PageLink(url string) string {
	return url + ".html"
}
...
func Index(site Site, title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, page := range site.Pages {
			...
			templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinURLErrs(PageLink(page.Url))
			if templ_7745c5c3_Err != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `index.templ`, Line: 19, Col: 56}
			}
